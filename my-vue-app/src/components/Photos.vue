...
<style scoped>
.photos {
  background-color: #e0f7fa; /* Warna latar belakang utama baru */
  padding: 20px;
  border-radius: 8px;
...
.photo-list li {
  background-color: #b2dfdb; /* Warna latar belakang item baru */
  padding: 10px;
  border-radius: 4px;
...
.photo-list li:hover {
  ...
  background-color: #80cbc4; /* Warna latar belakang saat hover baru */
}
...
.photo-list p {
  margin: 10px 0 0;
  color: #004d40; /* Warna teks item baru */
}
